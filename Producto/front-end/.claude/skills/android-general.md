...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `neversight-learn-skills.dev-android-development`                                |
| Version    | 1.0.1                                     |
| Author     | NeverSight                                 |
...
**GitHub:** [NeverSight/learn-skills.dev](https://github.com/NeverSight/learn-skills.dev) — ⭐ 53 | Forks: 12
...
This Skill encapsulates modern Android development practices using Kotlin and Jetpack Compose, designed for building robust, maintainable mobile apps. Key features include composable UI with Compose and Material3, Kotlin Coroutines and Flow for asynchronous and reactive programming, Jetpack libraries (ViewModel, Navigation, WorkManager, Lifecycle), dependency injection (Hilt), Room for persistence, Retrofit/OkHttp for networking, and Gradle/Android Studio tooling. It emphasizes architecture patterns (MVVM/MVI), unidirectional data flow, modularization, testing strategies (unit and UI), performance optimization, accessibility, localization, and Compose previews and animations. Use this Skill when creating or migrating Android apps, implementing Material Design, improving app architecture, or ensuring lifecycle-aware, testable, and scalable code. Core advantages are faster UI iteration, clearer state management, and alignment with Android best practices.



## Recent Comments

> **Codex Plus** (5/5) — 3/11/2026
> Installed and used in a Codex Android MCP server workflow. Instructions are clear and align with modern Kotlin + Compose practices.
...
```bash
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development
```
...
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install neversight-learn-skills.dev-android-development --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate neversight-learn-skills.dev-android-development --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment neversight-learn-skills.dev-android-development -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment neversight-learn-skills.dev-android-development
```
...
```bash
npx -y @lobehub/market-cli skills comments neversight-learn-skills.dev-android-development
```
