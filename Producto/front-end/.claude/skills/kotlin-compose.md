...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `a5c-ai-babysitter-kotlin-compose`                                |
| Version    | 1.0.0                                     |
| Author     | a5c-ai                                 |
...
**GitHub:** [a5c-ai/babysitter](https://github.com/a5c-ai/babysitter) — ⭐ 393 | Forks: 21
...
Kotlin/Jetpack Compose Development skill provides expert guidance and code generation for building native Android apps using Kotlin and Jetpack Compose. It helps create declarative UIs, custom composables, state handling with ViewModel/StateFlow/LiveData, navigation (Navigation Compose), theming (Material3), animations, and responsive layouts. Use it to scaffold new apps, migrate XML-based screens to Compose, prototype UI interactions rapidly with Compose Preview and live updates, integrate coroutines, dependency injection (Hilt), Room and Retrofit, and implement testing, accessibility, and localization. Features include best-practice app architectures (MVVM/Clean), interoperability with Android Views, performance profiling and optimization tips, and Compose-specific patterns for state hoisting and recomposition control. Core advantages: reduced boilerplate, faster iteration, consistent UI, improved maintainability, and modern Android platform alignment.
...
```bash
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose
```
...
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install a5c-ai-babysitter-kotlin-compose --version 1.0.0
```
...
```bash
npx -y @lobehub/market-cli skills rate a5c-ai-babysitter-kotlin-compose --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment a5c-ai-babysitter-kotlin-compose -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment a5c-ai-babysitter-kotlin-compose
```
...
```bash
npx -y @lobehub/market-cli skills comments a5c-ai-babysitter-kotlin-compose
```
