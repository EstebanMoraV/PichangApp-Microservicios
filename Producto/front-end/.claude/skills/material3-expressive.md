...
Expert guidance for implementing Material 3 Expressive, Dynamic Colors (Material You), and Material Motion in Android applications with Jetpack Compose.

| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `pedrobrantes-agents-android-material3-expressive`                                |
| Version    | 1.0.1                                     |
| Author     | pedrobrantes                                 |
...
**GitHub:** [pedrobrantes/agents](https://github.com/pedrobrantes/agents) — ⭐  | Forks: 
...
Provides expert guidance and practical patterns for implementing Material 3 Expressive, Dynamic Colors (Material You), and Material Motion in Android apps using Jetpack Compose. Covers how to integrate dynamicLightColorScheme/dynamicDarkColorScheme, generate tonal palettes and harmonize app palettes with user wallpapers, and supply robust fallbacks for older Android versions. Explains Compose-specific APIs and patterns—MaterialTheme (material3), colorScheme composition, Surface elevation tokens, AnimatedContent, updateTransition, animate*AsState, spring/physics animations, and Motion/transform patterns (shared axis, container transform, fade-through). Includes accessibility and contrast best practices, performance and testing tips, window inset/system bars handling, navigation transition guidance, and sample code structures for scalable, maintainable theming. Use this skill when you need modern, system-aware UI theming and motion that improves UX consistency and personalization across devices.
...
```bash
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive
```
...
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install pedrobrantes-agents-android-material3-expressive --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate pedrobrantes-agents-android-material3-expressive --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment pedrobrantes-agents-android-material3-expressive -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment pedrobrantes-agents-android-material3-expressive
```
...
```bash
npx -y @lobehub/market-cli skills comments pedrobrantes-agents-android-material3-expressive
```
