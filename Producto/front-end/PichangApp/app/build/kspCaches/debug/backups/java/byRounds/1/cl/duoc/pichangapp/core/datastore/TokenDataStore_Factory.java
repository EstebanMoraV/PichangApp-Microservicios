...
public final class TokenDataStore_Factory implements Factory<TokenDataStore> {
  ...
  public static TokenDataStore_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new TokenDataStore_Factory(Providers.asDaggerProvider(contextProvider));
  }
