...
public final class NetworkModule_ProvideOkHttpClientFactory implements Factory<OkHttpClient> {
  ...
  public static NetworkModule_ProvideOkHttpClientFactory create(
    ...
    return new NetworkModule_ProvideOkHttpClientFactory(Providers.asDaggerProvider(loggingInterceptorProvider), Providers.asDaggerProvider(authInterceptorProvider));
  }
